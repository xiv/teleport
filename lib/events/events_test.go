...
func TestJSON(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			json: `{"uid":"cd06365f-3cef-4b21-809a-4af9502c11a1","user":"foo","impersonator":"bar","sid":"test-session","with_mfa":"mfa-device","code":"TDT01I","event":"windows.desktop.session.end","time":"2020-04-23T18:22:35.35Z","ei":4,"cluster_name":"test-cluster","windows_user":"Administrator","windows_domain":"test.example.com","desktop_addr":"[::1]:34902","windows_desktop_service":"00baaef5-ff1e-4222-85a5-c7cb0cd8e7b8","desktop_labels":{"env":"production"}}`,
